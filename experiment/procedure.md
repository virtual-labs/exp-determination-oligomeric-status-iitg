...
![alt text](images/procedure-image.png)
...
![alt text](images/procedure-image-1.png)
...
2. Calculate the relative mobility (R<sub>f</sub>) using the following formula:

<p align="center" >
<b>R<sub>f</sub> = migration of protein from the lane / migration of tracking dye</b>
</p>
...
![alt text](images/procedure-image-2.png)

<p align="center" >
<b>Figure 4: Calibration curve of SDS-PAGE. The relationship between R<sub>f</sub> and Molecular weight of protein in SDS-PAGE.</b>
</p>

### B. Determination of native molecular weight of a protein using gel filtration chromatography

The molecular weight and size of a protein is related to the shape of the molecule and the relationship between molecular weight (M) and radius of gyration (R<sub>g</sub>) is as follows-

<p align="center" >
<b>R<sub>g</sub> ∝ M<sup>a</sup>…………………………………………Eq 32.4</b>
</p>
...
The set of known molecular weight standard protein can be run on a gel filitration column and elution volume can be calculated from the chromatogram (Figure 5). A separate run with the analyte will give elution volume for unknown sample. Using following formula, K<sub>d</sub> value for all standard protein and the test analyte can be calculated.

<p align="center" >
<b>K<sub>d</sub>=(V<sub>e</sub>-V<sub>o</sub>)/V<sub>i</sub></b>
</p>

A plot of K<sub>d</sub> versus log mol wt is given in Figure 5, B and it will allow us to calculate the molecular weight of the unknown analyte

![alt text](images/procedure-image-3.png)
...
For Lysozyme: log MW = 1.15; V<sub>e</sub> = 21 ml; K<sub>av</sub> = 0.8375
...
∴K<sub>av</sub> for unknown protein = 0.7558

![alt text](images/procedure-image-4.png)
...
∴ Molecular weight of unknown protein = 10<sup>1.245</sup>
